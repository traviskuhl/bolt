...
// register with external
b::external()->plug('beanstalk', '\bolt\external\beanstalk');

class beanstalk extends \bolt\plugin\factory {
	
	private $_handle;

	public function __construct($cfg=array()) {
		$this->_handle = new Socket_Beanstalk($cfg);
	}	
	...
	public function __get($name) {
		return (property_exists($this->_handle, $name) ? $this->handle->$name : false);
	}
